 ...
 */
VOLTRUM_API b8 vulkan_viewport_initialize(Vulkan_Context* context);
 ...
 * @param context - Vulkan context
 */
VOLTRUM_API void vulkan_viewport_shutdown(Vulkan_Context* context);
 ...
 * @param context - Vulkan context
 */
VOLTRUM_API void vulkan_viewport_render(Vulkan_Context* context);
 ...
 */
VOLTRUM_API void vulkan_viewport_resize(
 ...
 */
VOLTRUM_API VkDescriptorSet vulkan_viewport_get_texture(Vulkan_Context* context);
 ...
 * @param context - Vulkan context
 */
VOLTRUM_API void vulkan_viewport_update_descriptor(Vulkan_Context* context);