...
// Texture services for UI module
VkDescriptorPool vulkan_create_descriptor_pool(Vulkan_Context* context);
VkSampler vulkan_create_linear_sampler(Vulkan_Context* context);
